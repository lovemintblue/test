...
use App\Models\ReportAdvLogModel;

/**
 * 广告统计
 * @property  ReportAdvLogModel $reportAdvLogModel
 */
class ReportAdvLogService extends BaseService
{
    ...
    private function do($advId, $advName, $field, $channelName,$value = 1)
    {
        ...
        $this->reportAdvLogModel->findAndModify([
            '_id' => $idValue,
        ], [
            '$set' => [
                'name'  => $advName,
    ...
    {
        $count = $this->reportAdvLogModel->aggregate([
            [
                '$match' => [
                    'label'=>$date,
                    'channel_name'=>$channelName

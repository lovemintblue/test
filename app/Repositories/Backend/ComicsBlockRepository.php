...
class ComicsBlockRepository extends BaseRepository
{
    ...
    public function getList($request)
    {
        ...
        $fields = array();
        $count  = $this->comicsBlockService->count($query);
        $items  = $this->comicsBlockService->getList($query, $fields, array($sort => $order), $skip, $pageSize);
    ...
    public function save($data)
    {
        ...
        return $this->comicsBlockService->save($row);
    }
    ...
    {
        $row = $this->comicsBlockService->findByID($id);
        if (empty($row)) {
    ...
    {
        return $this->comicsBlockService->delete($id);
    }

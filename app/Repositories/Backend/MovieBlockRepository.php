...
class MovieBlockRepository extends BaseRepository
{
    ...
    public function getList($request)
    {
        ...
        $fields = array();
        $count  = $this->movieBlockService->count($query);
        $items  = $this->movieBlockService->getList($query, $fields, array($sort => $order), $skip, $pageSize);
    ...
    public function save($data)
    {
        ...
        return $this->movieBlockService->save($row);
    }
    ...
    {
        $row = $this->movieBlockService->findByID($id);
        if (empty($row)) {
    ...
    {
        return $this->movieBlockService->delete($id);
    }

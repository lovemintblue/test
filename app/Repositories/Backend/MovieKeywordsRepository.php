...
class MovieKeywordsRepository extends BaseRepository
{
    ...
    public function getList($request)
    {
        ...
        $fields = array();
        $count  = $this->movieKeywordsService->count($query);
        $items  = $this->movieKeywordsService->getList($query, $fields, array($sort => $order), $skip, $pageSize);
    ...
    {
        $row = $this->movieKeywordsService->findByID($id);
        if (empty($row)) {
    ...
    public function save($data)
    {
        ...
        if ($this->movieKeywordsService->movieKeywordsModel->count(['_id'=>$row['_id']])) {
            return $this->movieKeywordsService->save($row);
        }else{
            return $this->movieKeywordsService->movieKeywordsModel->insert($row);
        }
    }
    ...
    {
        return $this->movieKeywordsService->save($data);
    }
    ...
    {
        return $this->movieKeywordsService->delete($id);
    }

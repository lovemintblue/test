...
class ComicsRepository extends BaseRepository
{
    ...
    public function getList($request)
    {
        ...
        $items  = $this->comicsService->getList($query, $fields, array($sort => $order,), $skip, $pageSize);
    ...
    public function save($data)
    {
        ...
        $result= $this->comicsService->save($row);
        if($row['_id']){
            $this->comicsService->asyncEs($row['_id']);
        }
        return $result;
    }
    ...
    {
        $this->comicsService->asyncMrsById($id);
        return true;
    }
    ...
    {
        $row = $this->comicsService->findByID($id);
        if (empty($row)) {
    ...
    {
        return $this->comicsService->getChapterList($id);
    }
